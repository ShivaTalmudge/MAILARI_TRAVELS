...
import { 
  LayoutDashboard, Map, Car, User, LogOut, Menu, X, PlaneTakeoff
} from 'lucide-react';
...
export default function DriverLayout() {
  ...
  return (
    <div className="flex h-screen bg-slate-50">
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-brand-900 text-brand-100 transition-transform duration-300 md:static md:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
